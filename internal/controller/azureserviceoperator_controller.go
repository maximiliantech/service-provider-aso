...
func (r *AzureServiceOperatorReconciler) CreateOrUpdate(ctx context.Context, svcobj *apiv1alpha1.AzureServiceOperator, _ *apiv1alpha1.ProviderConfig, clusters spruntime.ClusterContext) (ctrl.Result, error) {
